 ...
 * instant per the project's standing performance requirement.
 *
        ...
        createPortal(
          ...
          >
            ...
            <div
              ...
              className={`absolute inset-y-0 right-0 flex w-[82vw] max-w-sm flex-col bg-cream shadow-2xl transition-transform duration-300 ease-out ${
            ...
            >
              ...
              <nav className="mt-4 flex flex-col px-6">
                {nav.map((item) => (
                  <Link
                    ...
                    tabIndex={open ? 0 : -1}
                    className="border-b border-beige-border/70 py-4 font-heading text-2xl text-charcoal data-[active=true]:text-terracotta"
                  >
                    {item.label}
                  </Link>
                ))}
              ...
              <div className="mt-auto flex flex-col gap-4 border-t border-beige-border/70 px-6 py-6">
